...
# AI-Tournaments
[AI-Tournaments](https://ai-tournaments.github.io/) is platform for match match making between algorithms. Users can make their own participates to compete in any of the existing arenas, or make their own custom arena and challenge other users to join. <!-- Keep in sync with social platforms: LinkedIn -->
